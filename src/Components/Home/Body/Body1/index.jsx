    ...
    <Row style={{ backgroundColor: "#F7F7F7 " }}>
      <Row className="mt-3 pt-5 text-center">
        <Col>
          <Typography className="dfs-title" paragraph={true}>
            <b>Abra su cuenta de inversión en simples pasos</b> y acceda al
            mercado de capitales desde su cuenta como Persona Física o Persona
            Jurídica.
          </Typography>
      ...
      <Row className="mt-5 mb-5 text-center">
        <Col xs={12} xl={{ span: 6, offset: 3 }}>
          <a
            href="https://aperturadecuenta.dealfs.com.ar/"
            target="_blank"
            rel="noreferrer"
          >
